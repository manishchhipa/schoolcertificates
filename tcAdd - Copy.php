                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Transfer Certificate <small>Add</small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
								...
								<?php } ?>
									   <div class="col-lg-6">
										 <form action="control/admin_employee.php" id="tcAdd" role="form" method="post">
											...
											<input  class="form-control" name = "session" value=""/> 	 
											<input  class="form-control" name = "reason" value=""/> 	 
											<input  class="form-control" name = "pass" value=""/> 	 
											<input  class="form-control" name = "examination_of_pass" value=""/> 	 
											<input  class="form-control" name = "fail" value=""/> 	 
											<input  class="form-control" name = "examination_of_fail" value=""/> 	 
											<input  class="form-control" name = "division" value=""/> 	 
											<input  class="form-control" name = "conduct" value=""/> 	 
